    ...
    <div className="App">
      ...
      <section className="project">
        <div className="project-item project-left">
          ...
          <ul>
            <li><b>Backend: </b>Developed using <b>Express</b> and <b>MongoDB</b>, with a focus on designing efficient schemas and building secure, <b>JWT-authenticated</b> RESTful APIs</li>
